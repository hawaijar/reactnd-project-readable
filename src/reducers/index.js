...
import { ADD_COMMENT, EDIT_COMMENT, DELETE_COMMENT, EDIT_POST } from '../actions';

const initialState = {
  '1504323052905': {
    title: 'The amazing Spiderman',
    body: `The Amazing Spider-Man is a 2012 American superhero film based on the Marvel Comics character Spider-Man, and sharing the title of the character's longest-running comic book. It is the fourth theatrical Spider-Man film produced by Columbia Pictures and Marvel Entertainment, and a reboot of Sam Raimi's Spider-Man 2002-2007 trilogy preceding it. The film was directed by Marc Webb. The film tells the story of Peter Parker, a teenager from New York who becomes Spider-Man after being bitten by a genetically altered spider. Parker must stop Dr. Curt Connors as a mutated lizard, from spreading a mutation serum to the city's human population.`,
